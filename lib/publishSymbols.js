...
exports.findAllVersions = exports.find = exports.getSymbolServiceUri = exports.unpublishSymbols = exports.publishSymbols = exports.updateSymbolClient = exports.replaceDbgHelpDLL = exports.unzipSymbolClient = exports.runSymbolCommand = exports.getSymbolClientVersion = exports.downloadSymbolClient = void 0;
...
function replaceDbgHelpDLL(destinationDirectory) {
    return __awaiter(this, void 0, void 0, function* () {
        // Copy all dlls from the bin/ folder to the destinationDirectory.
        const binPath = path_1.default.join(__dirname, 'bin');
        const dlls = fs_1.default.readdirSync(binPath).filter(file => file.endsWith('.dll'));
        for (const dll of dlls) {
            fs_1.default.copyFileSync(path_1.default.join(binPath, dll), path_1.default.join(destinationDirectory, dll));
            core.info(`Copied ${dll} to ${destinationDirectory}`);
        }
    });
}
exports.replaceDbgHelpDLL = replaceDbgHelpDLL;
function updateSymbolClient(accountName, symbolServiceUri, personalAccessToken) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield replaceDbgHelpDLL(toolPath);
        return toolPath;
    });
}
